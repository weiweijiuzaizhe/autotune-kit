...
DEMO_BASE_TRAIN_YAML = Path("/root/ATK_V0_1_Demo_20260214_070303/train.yaml")
...
def _make_lf_yaml(run_dir: Path, cfg: Dict[str, Any], dataset_dir: Path, output_model_dir: Path) -> Path:
    ...
    base_yaml = DEMO_BASE_TRAIN_YAML
...
def run_pipeline(cfg_path: str, raw_cfg: Dict[str, Any]) -> int:
    run_dir = create_run_dir("/root/atk_runs")
    ...
    safe = run_safe_launch(
        ...
        base_train_yaml=DEMO_BASE_TRAIN_YAML,
